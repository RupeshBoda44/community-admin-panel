...
export class VillageComponent implements OnInit {
  ...
  fetchList() {
    ...
    this.http.get<any>(`${this.baseUrl}/admin/village/list`, { params }).subscribe({
      next: (res) => {
  ...
  save() {
    ...
    const req = this.drawerMode === 'add'
      ? this.http.post(`${this.baseUrl}/admin/village`, payload)
      : this.http.put(`${this.baseUrl}/admin/village/${this.selectedItem.id}`, payload);
  ...
  confirmDelete(item: any) {
    ...
    ref.afterClosed().subscribe(confirmed => {
      if (confirmed) {
        this.http.delete(`${this.baseUrl}/admin/village/${item.id}`).subscribe(() => this.fetchList());
      }
    });
  }
